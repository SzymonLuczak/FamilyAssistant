...
Aktualizacja (WhatsApp): propozycje wysłane na grupę „Proponowane Zakupy”, odpowiedź `1-3` z telefonu odebrana, lista „Do kupienia” dostarczona na grupę „Tablica informacyjna”. Wymagało ponownego sparowania urządzenia (poprzednie nie odszyfrowywało wiadomości przychodzących) oraz odczytu identyfikatorów wiadomości w nowym formacie WhatsApp Web. Bramka WhatsApp: 13/13 testów. Testy Core po tej zmianie do uruchomienia.
